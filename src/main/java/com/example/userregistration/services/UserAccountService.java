...
import com.example.userregistration.repositories.UserAccountRepository;
...
public class UserAccountService implements UserDetailsService {
    ...
    public String signUpUser(UserAccount userAccount) {
       ...
       //save user
        ...
        String body = buildEmailBody(userAccount.getFirstName(),link);


//        TODO: SEND EMAIL
        emailSenderService.sendConfirmationLink(userAccount.getEmail(),body);
    ...
    public int enableAppUser(String email) {
        ...
        return userAccountRepository.enableUser(email);
    }
